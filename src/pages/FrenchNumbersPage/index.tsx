import styles from "./FrenchNumbersPage.module.scss";
import { generateRandomNumber, numbersInFrench } from "./frenchNumbersUtils";
import { useState, useEffect } from "react";

const FrenchNumbersPage = () => {
...
export default FrenchNumbersPage;
